...
func (c *todoServiceClient) ListAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/template.TodoService/ListAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*Todo, error) {
	out := new(Todo)
	err := c.cc.Invoke(ctx, "/template.TodoService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Todo, error) {
	out := new(Todo)
	err := c.cc.Invoke(ctx, "/template.TodoService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TodoService_ListAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/template.TodoService/ListAll",
	}
...
func _TodoService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/template.TodoService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/template.TodoService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
